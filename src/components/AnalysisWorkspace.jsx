...
const LOCAL_TRANSLATIONS = {
  is: {
    ...
    bondDesc: "Skuldabréfaálag (t.d. á milli áhættusamra og öruggra ríkisbréfa) endurspeglar greiðsluhæfi og lausafjárstöðu á mörkuðum. Hækkun álagskrafna þýðir dýrari fjármögnun fyrir fyrirtæki, sem hækkar ávöxtunkröfu og dregur úr virði framtíðarsjóðstreymis í hefðbundnum fjármálalíkönum.",
    commDesc: "Flökt á hrávörum (s.s. olíu og gasi) þjónar sem beinn staðgengill fyrir framboðstruflanir og verðbólguþrýsting. Miklar verðsveiflur auka óvissu um rekstrarkostnað fyrirtækja, herða að framlegð og þvinga fram breytingar á framleiðsluvirði.",
    polyDesc: "Dreifstýrðir spámarkaðir þjóna sem framsýnn vísir á makróbreytur (s.s. vaxtaákvarðanir og verðbólguspár). Þessir markaðir safna upplýsingum hratt úr dreifðum áttum og gefa rauntímavísbendingu um væntingar markaðarins, oft á undan opinberum hagskýrslum.",
    viewCTA: "SKOÐA",
